...
// Modal Context - Centralized modal management with nested modal support
import {
  createContext,
  useContext,
  useState,
 ...
 * Provides centralized modal state management with:
 * - Modal stack for tracking open modals
 * - Nested modal support with separate callback stack
 ...
 * @returns {Object} Modal context with all modal management functions
 */
